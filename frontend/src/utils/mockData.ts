  ...
  nodes: [
    {
      ...
      dependencyCount: { outgoing: 5, incoming: 0 },
    },
    {
      id: 'auth-service',
      displayName: '인증서버',
      ...
      dependencyCount: { outgoing: 2, incoming: 4 },
    },
    {
      id: 'user-service',
      displayName: '사용자서버',
      language: 'java',
      framework: 'Spring Boot',
      dependencyCount: { outgoing: 3, incoming: 3 },
    },
    {
      id: 'order-service',
      displayName: '주문서버',
      ...
      dependencyCount: { outgoing: 4, incoming: 2 },
    },
    {
      id: 'payment-service',
      displayName: '결제서버',
      language: 'java',
      framework: 'Spring Boot',
      dependencyCount: { outgoing: 1, incoming: 3 },
    },
    {
      ...
      language: 'typescript',
      framework: 'NestJS',
      dependencyCount: { outgoing: 0, incoming: 4 },
    },
    {
      ...
      language: 'python',
      framework: 'FastAPI',
      dependencyCount: { outgoing: 1, incoming: 2 },
    },
    {
      ...
      language: 'python',
      framework: 'Django',
      dependencyCount: { outgoing: 0, incoming: 3 },
    },
    {
      id: 'file-service',
      displayName: '파일서버',
      language: 'go',
      framework: 'Gin',
      dependencyCount: { outgoing: 0, incoming: 2 },
    },
    {
      id: 'search-service',
      displayName: '검색서버',
    ...
    },
    {
      ...
      dependencyCount: { outgoing: 0, incoming: 5 },
    },
    {
      id: 'frontend-bff',
      ...
      language: 'typescript',
      framework: 'NestJS',
      dependencyCount: { outgoing: 4, incoming: 1 },
    },
  ],
  edges: [
    {
